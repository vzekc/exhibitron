...
const breadcrumbMap: { [key: string]: string } = {
  ...
  '/user/umfrage': 'Fragen der Orga',
  '/user/umfrage/ergebnisse': 'Antworten',
  '/admin/umfrage': 'Fragen an Aussteller',
  '/admin/umfrage/neu': 'Neue Frage',
  '/admin/mitmachen': 'Mitmachen',
