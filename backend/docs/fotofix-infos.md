...
darin liegt dasselbe Bild in 56 Formaten unter festen Namen:
...
Jede Foto-ID ist ein Verzeichnis. Darin liegt das Original als `photo.jpg`, und daneben liegen 56
...
| --------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Commodore C64         | `c64.prg`                                                                                                                                                                     | BASIC-Starter, 6502-Anzeiger, 320 × 200 monochrom                                                                                                                                                                                                                                                                                                                      |
...
| NKC mit GDP64         | `nkc-gdp64.pbm`                                                                                                                                                               | 512 × 256 mono für den KERMIMG-Anzeiger im ROM                                                                                                                                                                                                                                                                                                                         |
| Videotex              | `minitel.vdt`, `minitel-mono.vdt`, `btx.cept`, `btx-basic.cept`, `btx-drcs.cept`, `btx-drcs-double.cept`                                                                      | Télétel-Seiten für das Minitel 1B und CEPT-Seiten für den BTX-Decoder, die das Terminal beim Empfang aufbaut: 80 × 66 Mosaikblöcke über den ganzen Schirm, in den Graustufen des Minitel bzw. in sechzehn aus dem Foto gewonnenen Farben; die DRCS-Fassungen laden einen eigenen Zeichensatz und tragen damit ein echtes 144 × 70-Bitmap, wahlweise in doppelter Größe |
| Terminals             | `ascii-terminal.txt`, `ascii-terminal-full.txt`, `vt240.six`, `vt241.six`, `tektronix-4010.tek`, `tektronix-4014.tek`, `tektronix-trace-4010.tek`, `tektronix-trace-4014.tek` | ASCII-Kunst 80 × 24 in zwei Zeichenvorräten; Sixel 800 × 240 in vier Graustufen bzw. vier Farben; Speicherröhre als Schraffur oder als Umrisszeichnung                                                                                                                                                                                                                 |
...
| Austauschformate      | `photo.jpg`, `png.png`, `gif.gif`, `pcx.pcx`, `pcx-color.pcx`, `ppm-24.ppm`, `ppm-16.ppm`, `ppm-8.ppm`, `ppm-48.ppm`, `pgm-8.pgm`, `pbm.pbm`, `xbm.xbm`                       | 640 × 480 für jede Maschine mit eigenem Bildlader; XBM als C-Quelle, die ein X-Client übersetzen kann                                                                                                                                                                                                                                                                  |

Jeder mitgelieferte Anzeiger schreibt zwei Bildunterschriften im Zeichensatz der Zielmaschine: oben
links „Classic Computing 2026 – Celle“, unten rechts den Systemnamen. Die Austauschformate sind das
Foto allein.
...
der Webcam aufnehmen, ID bekommen, und der Server rechnet dieselben 56 Formate daraus. Die Dateien
