...
import { Presentation } from './modules/presentation/entity.js'
import { PresentationRepository } from './modules/presentation/repository.js'
...
export async function initORM(options?: Options): Promise<Services> {
  ...
  return (cache = {
    ...
    presentation: orm.em.getRepository(Presentation),
  })
}
